...
void UpdateAsserv()
{
    ...
    CorrLin.I_Output = CorrLin.I_Output + ((CorrLin.Error * CorrLin.Ki) / FREQ_ECH_QEI);
    CorrLin.I_Output = LimitToInterval(CorrLin.I_Output, -10, 10);
    
    //à suppr dans la boule fermée
    ...
    CorrAngl.I_Output = CorrAngl.I_Output + ((CorrAngl.Error * CorrAngl.Ki) / FREQ_ECH_QEI);
    CorrAngl.I_Output = LimitToInterval(CorrAngl.I_Output, -10, 10);
    
    //à suppr dans la boucle fermée 
